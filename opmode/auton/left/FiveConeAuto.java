package org.firstinspires.ftc.teamcode.opmode.auton.blue.left;
...
@Autonomous (name = "BLUE LEFT 5 Cone Auto", group = "_ared")
public class FiveConeAuto extends LinearOpMode {
    ...
    private SignalSleeveWebcam signalSleeveWebcam = new SignalSleeveWebcam(this, "leftWebcam");
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.setPoseEstimate(AutoConstants.BL_START_POSE);

        TrajectorySequence preload = drive.trajectorySequenceBuilder(AutoConstants.BL_START_POSE)
                .setTangent(Math.toRadians(90))
                .lineToLinearHeading(new Pose2d(AutoConstants.BL_CENTER_X, AutoConstants.BL_HIGH_GOAL_Y, AutoConstants.BL_HEADING))
                .lineToLinearHeading(new Pose2d(AutoConstants.BL_HIGH_GOAL_X + AutoConstants.BL_PRELOAD_X_OFFSET, AutoConstants.BL_HIGH_GOAL_Y, AutoConstants.BL_HEADING))
                .waitSeconds(0.2)
                .build();

        preloadToConeStack = drive.trajectorySequenceBuilder(preload.end())
                .lineToLinearHeading(new Pose2d(AutoConstants.BL_CENTER_X, AutoConstants.BL_HIGH_GOAL_Y, AutoConstants.BL_HEADING))
                .lineToLinearHeading(new Pose2d(AutoConstants.BL_CENTER_X, AutoConstants.BL_PRELOAD_CONE_STACK_Y, AutoConstants.BL_HEADING))
                .setReversed(true)
                .setTangent(Math.toRadians(AutoConstants.BL_CONE_STACK_ANGLE + AutoConstants.BL_CONE_STACK_ANGLE_OFFSET))
                .splineToConstantHeading(AutoConstants.BL_CONE_STACK_VECTOR, Math.toRadians(AutoConstants.BL_CONE_STACK_END_ANGLE))
                .build();

        coneStackToHighGoal = drive.trajectorySequenceBuilder(preloadToConeStack.end())
                .setReversed(false)
                .setTangent(Math.toRadians(AutoConstants.BL_HIGH_GOAL_TANGENT))
                .splineTo(AutoConstants.BL_HIGH_GOAL_VECTOR, Math.toRadians(AutoConstants.BL_HIGH_GOAL_ANGLE))
                .waitSeconds(0.2)
                .build();

        highGoalToConeStack = drive.trajectorySequenceBuilder(coneStackToHighGoal.end())
                .setReversed(true)
                .setTangent(Math.toRadians(AutoConstants.BL_CONE_STACK_ANGLE))
                .splineTo(AutoConstants.BL_CONE_STACK_VECTOR, Math.toRadians(AutoConstants.BL_CONE_STACK_END_ANGLE))
                .build();
